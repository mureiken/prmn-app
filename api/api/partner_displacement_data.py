...
@partner_displacement_data.route('/partner-displacement-data/<regions>/<districts>/<needs>/<causes>/<period>', defaults={'start': None, 'end': None}, methods=['GET'])
@partner_displacement_data.route('/partner-displacement-data/<regions>/<districts>/<needs>/<causes>/<period>/<start>/<end>', methods=['GET'])
...
def all (regions, districts, needs, causes, period, *args, **kwargs):
